...
//            easy.createGame(layout, stage, outlook, easyMode, mediumMode, hardMode, insaneMode);
//            Scene gameMode = new Scene(layout);
//            stage.setScene(gameMode);
//        });
//        mediumMode.setOnAction((event) -> {
//            medium.createGame(layout, stage, outlook, easyMode, mediumMode, hardMode, insaneMode);
//            Scene gameMode = new Scene(layout);
//            stage.setScene(gameMode);
//        });
//        hardMode.setOnAction((event) -> {
//            hard.createGame(layout, stage, outlook, easyMode, mediumMode, hardMode, insaneMode);
//            Scene gameMode = new Scene(layout);
//            stage.setScene(gameMode);
//        });
//        insaneMode.setOnAction((event) -> {
//            insane.createGame(layout, stage, outlook, easyMode, mediumMode, hardMode, insaneMode);
//            Scene gameMode = new Scene(layout);
//            stage.setScene(gameMode);
//        });
